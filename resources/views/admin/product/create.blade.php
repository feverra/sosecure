    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-sample" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Detail</label>
                    {!! Form::textarea('detail', null, array('class' => 'form-control form-control-lg', 'rows' => 20, 'required')) !!}
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Price</label>
                            {!! Form::number('price', null, array('class' => 'form-control form-control-lg', 'required')) !!}
                        </div>
                    </div>
                    {{-- <div class="col-md-4">
                        <div class="form-group">
                            <label>Promotion Price</label>
                            {!! Form::text('promotion_price', null, array('class' => 'form-control form-control-lg')) !!}
                        </div>
                    </div> --}}
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>In Stock</label>
                            {!! Form::number('in_stock', null, array('class' => 'form-control form-control-lg', 'required')) !!}
                        </div>
                    </div>
                </div>
