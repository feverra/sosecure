...
<div class="col-12 grid-margin">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="card-title">Edit New Blog</h4>
                </div>
                <div class="col-lg-6">
            ...
            @endif
            <form class="form-sample" action="{{ route('blogs.update', encrypt_decrypt('encrypt',$blog->id)) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group">
                    ...
                    <img class="card-img rounded-0" id="show_photo" src="{{ asset(''.$blog -> photo .'')}}">
                </div>
                <div id="info">
                    <p><img id="blah" src="#"/></p>
                ...
                <div class="form-group">
                    <label>Title</label>
                    {!! Form::text('title', $blog -> title, array('class' => 'form-control form-control-lg', 'required')) !!}
                </div>
                <div class="form-group">
                    <label>Detail</label>
                    {!! Form::textarea('detail', $blog -> detail, array('class' => 'form-control form-control-lg', 'rows' => 20, 'required')) !!}
                </div>
    ...
    <script>
        $(function () {
            $("[type=file]").on("change", function () {
                ...
                // if (file.name.length >= 30) {
                //     $('#choose_file').text("Chosen : " + file.name.substr(0, 30) + '..');
                // } else {
                //     $('#choose_file').text("Chosen : " + file.name);
                // }
                $('#show_photo').hide();
